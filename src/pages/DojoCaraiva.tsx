      ...
      <section>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <img src={sorteio2} alt="Mestre Suellen, Mateus Tafuri e aluno premiado no sorteio do Dojo Caraíva" className="w-full rounded-2xl object-cover h-72 object-[center_15%]" loading="lazy" />
