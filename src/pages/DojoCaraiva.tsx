      ...
      <section>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <img src={sorteio1} alt="Aluna do Dojo Caraíva no dia do sorteio da rifa solidária" className="w-full rounded-2xl object-cover h-72 object-[center_20%]" loading="lazy" />
