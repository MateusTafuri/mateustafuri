...
const cases = [
  ...
  { img: caseBonete, logo: logoBonete, name: "Projeto Social l Dojo Bonete", desc: "Uma comunidade isolada, um professor de jiu jitsu e um sonho que construíram muito mais que um espaço.", location: "Ilhabela, SP", path: "/dojo-bonete", imgPosition: "center 65%" },
