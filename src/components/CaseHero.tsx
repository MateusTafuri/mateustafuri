...
/* Topo de um case: texto à esquerda e três peças flutuando à direita.
   Duas em pé atrás e uma deitada atravessada na frente. */
...
const CaseHero = ({ tipo, titulo, destaque, descricao, logo, logoAlt, pecas }: Props) => (
  <header
    ...
    style={{
      background: "var(--case-grad, linear-gradient(165deg, #0f1f18 0%, #14271e 45%, #193024 100%))",
      color: CREME,
    }}
  >
    <div
    ...
    <div className="relative mx-auto grid max-w-5xl items-center gap-10 md:grid-cols-[1.05fr_0.95fr]">
      <div>
        ...
        <h1 className="mt-1 font-display text-5xl font-extrabold leading-[0.95] tracking-tight md:text-7xl">
          {titulo} <span className="text-[var(--case-destaque,#A9C46C)]">{destaque}</span>
        </h1>
